...
%---------------------------------------------------------
  \cventry
    {Founding Full-Stack Engineer} % Job title
    {\href{https://google.com}{Stealth Mode Start-Up}} % Organization
    {Remote} % Location
    {Jun. 2024 - Dec. 2025} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Built a customer sales platform designed to channel business opportunities directly into our ecosystem while providing accelerated feedback to potential customers.}
      \end{cvitems}
    }
